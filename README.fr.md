...
Un cadre théorique proposant que la Lune se soit formée par une triple transition de phase au sein de la proto-Terre en différenciation. Le modèle relie des transitions rhéologique, mécanique et magnétique pilotées par la ségrégation progressive Fe-Ni, et prédit une stratigraphie interne lunaire testable, vérifiable par les données sismiques de Chang'e 7 (août 2026) et Artémis III (2028–2029).
