...
# Formation de la Lune par Triple Transition de Phase dans la Proto-Terre en cours de différenciation — Édition définitive
...
**La théorie tiendra ou tombera sur les données.**
...
5. **Couples des CME T-Tauri** — perturbations impulsives quotidiennes sur le vecteur de spin
...
| P7 | Signature Hf-W : 100 ± 10 Ma après les CAI (contre 60 ± 10 Ma pour l'impact géant) | Artemis III | 2028–2029 |
...
| P22 | Seuil d'émergence du double puits : critère unifié sur la surface couplée (Ω, g_eff), fermé par les trois mécanismes complémentaires de densité, obliquité et bombardement planétésimal | Simulation SPH 3D | En attente (L1, L2) |
...
| Fichier | Description |
|---------|-------------|
| `The_Moon_Formation_Triple_Phase_Transition_Engine_Version_EN.pdf` | Manuscrit complet — anglais (dernière version) |
...
|------------|-------------|------|--------|
| Zenodo (cette version) | [10.5281/zenodo.20760018](https://doi.org/10.5281/zenodo.20760018) | 2 juillet 2026 | ✅ ⭐ |
...
DEBAILLEUL, M. (2026). *Formation de la Lune par Triple Transition de Phase dans la Proto-Terre en cours de différenciation — Édition définitive.* Zenodo. https://doi.org/10.5281/zenodo.20760018
